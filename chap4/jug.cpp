...
int main()
{
    ...
    std::cout << "Two Jugs Problem: Measure exactly 4 liters of water using a 3-liter jug and a 5-liter jug."
              << std::endl;
    for (int step = 1; step <= maxSteps; ++step)
    {
        ...
        std::cout << "3. Pour the water from the 3-liter jug into tho 5-liter jug" << std::endl;
        std::cout << "4. Pour the water from the 5-liter jug into tho 3-liter jug" << std::endl;
        ...
        if (action == 7)
        {
            ...
            std::cout << "1. Fill the 3-liter jug" << std::endl;
            std::cout << "2. Pour the water from the 3-liter jug in the 5-liter jug" << std::endl;
        ...
        {
            std::cout << std::endl
                      << "Congratulations! You've solved the riddle and measured exactly 4 litters of water in " << step
                      << " steps" << std::endl;
            solved = true;
            break;
        }
